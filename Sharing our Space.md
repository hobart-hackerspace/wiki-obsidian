...
We share our Space with other members. That gives us the benefit of shared tools and shared ideas. But it also gives each of us responsibilities.

Some of those responsibilities are in our [Terms of Use](https://hobarthackerspace.org.au/terms_of_use/), which you have to agree with to join with us.

Others are more general, but are summed up by:
...
- **Check and/or recharge batteries** for portable tools when you finish with them for the day.
- **Don't leave unfinished jobs** or unused materials in or on fixed tools like CNC, laser cutter, 3D printers etc. It blocks others from using the tool. When you're done, clean the tool up for the next person.
