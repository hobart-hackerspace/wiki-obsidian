# What is *Wikmd*?
It’s a file-based wiki that aims to simplicity. The documents are completely written in Markdown which is an easy markup language that's familiar to most developers and you can learn in 60 sec.

It's open-source, free software; the source repository is at [github.com/Linbreux/wikmd](https://github.com/Linbreux/wikmd) and the documentation is at [linbreux.github.io/wikmd](https://linbreux.github.io/wikmd/).
...
- It's also easy to generate well-formatted printable pages for off-line use

## How does it work?
Instead of storing the data in a database *Wikmd* uses a file-based system. The advantage of this system is that every file is directly readable inside a terminal etc. Also when you have direct access to the system you can export the files to anything you like.
