...
The firewall device is a [Ubiquiti Router & WiFi controller](WiFi7%20upgrade%202025.md). Connect to it from within the Space at [`192.168.2.1`](http://192.168.2.1). (The credentials are in [the password vault](Password%20vault.md).) Its management page is accessible from the WAN by logging into [Ubiquiti Unifi](https://unifi.ui.com/).
