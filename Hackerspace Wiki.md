...
- This wiki
	- [Adding your content](Contributing%20using%20`git`%20as%20a%20separate%20application.md). The easy way to add content is to start with another page and copy its source into your new page.
...
Details on how to add to or change it are in the [How to use this wiki](Contributing%20using%20`git`%20as%20a%20separate%20application.md) page. 
