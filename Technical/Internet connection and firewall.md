...
The credentials to connect to the Launtel management page are in [the password vault](Governance/Password%20vault.md).
...
The firewall device is a [Ubiquiti Router & WiFi controller](Technical/WiFi7%20upgrade%202025.md). Connect to it from within the Space at [`192.168.2.1`](http://192.168.2.1). (The credentials are in [the password vault](Governance/Password%20vault.md).) Its management page is accessible from the WAN by logging into [Ubiquiti Unifi](https://unifi.ui.com/).

[Ubiquiti Router & WiFi controller](Technical/WiFi7%20upgrade%202025.md)
...
## [IP address reservations](Technical/IP%20address%20leases.md)

## [Externally exposed hosts](Technical/Exposed_ports.md)
